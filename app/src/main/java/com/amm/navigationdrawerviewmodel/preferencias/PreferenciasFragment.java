package com.amm.navigationdrawerviewmodel.preferencias;
...
import com.amm.navigationdrawerviewmodel.main.SharedViewModel;
...
public class PreferenciasFragment extends Fragment  {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //Obtenemos el color seleccionado desde el sharedViewModel
        selectedColor = sharedViewModel.getSelectedColor();

        //Si ya se ha seleccionado un color
